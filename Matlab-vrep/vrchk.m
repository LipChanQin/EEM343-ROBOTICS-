...
% (See http://www.gnu.org/copyleft/gpl.html)
  ...
  if res == sim.simx_error_noerror,
    % Nothing to say
    return;
  elseif res == sim.simx_error_novalue_flag,
    if buffer,
